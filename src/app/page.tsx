              ...
              {savedJourney && savedJourney.showNotification !== false && (
                <div className="mt-4">
                  <div 
                    ...
                    className="bg-green-50 border border-green-200 rounded-lg p-3 transition-all duration-300 cursor-pointer hover:bg-green-100 hover:border-green-300 active:bg-green-200"
                  >
