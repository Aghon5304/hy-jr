...
export async function GET(request: NextRequest) {
  ...
  // Parse parameters
  const sourcesParam = searchParams.get('sources') || 'krakow1,krakow2,krakow3,ald,kml';
